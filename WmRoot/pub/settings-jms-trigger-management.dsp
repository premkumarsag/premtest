                ...
                <tr id="%value trigger/groupParentId encode(html)%" name="trigList"  >
                  ...
                  <script>writeTDnowrap("col");</script>
                    ...
                    %case '0'%
                      %ifvar trigger/currentThreads equals('-1')%
                        ...
                        <img style="width: 13px; height: 13px;" alt="active" border="0" src="images/yellow_check.png">
					              ...
					              <script>
							            if(is_csrf_guard_enabled && needToInsertToken) {
								            document.write('<a href="javascript:document.htmlform_settings_jms_edit_state_enabled_not_connected_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
						              }else {
							              document.write('<a href="settings-jms-edit-state.dsp?triggerName=%value node_nsName encode(url)%&setState=EnabledButNotConnected&type=standard&triggerFilterValue=%value ../triggerFilterValue encode(url)%&aliasFilterValue=%value ../aliasFilterValue encode(url)%&destinationFilterValue=%value ../destinationFilterValue encode(url)%&groupHeader=%value trigger/groupHeader encode(url)%">%value trigger/stateLocalizedString%<br></a>');
							            }
					              </script>
                      ...
                      %else%
                        ...
                        <script>
							            if(is_csrf_guard_enabled && needToInsertToken) {
							              document.write('<a href="javascript:document.htmlform_settings_jms_edit_state_enabled_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
						              }else {
                    ...
                    %case '1'%
                      ...
                      <script>
									      if(is_csrf_guard_enabled && needToInsertToken) {
									        document.write('<a href="javascript:document.htmlform_settings_jms_edit_state_disabled_%value $index%.submit();">%value trigger/stateLocalizedString%</a>');
								        }else {
                    ...
                    %case '2'%                     
                      ...
                      <script>
						            if(is_csrf_guard_enabled && needToInsertToken) {
					              	document.write('<a href="javascript:document.htmlform_settings_jms_edit_state_suspended_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
					              }else {
                    ...
                    %case%
                      ...
                      %else%
                        ...
                        %endif%
                      %endif%
                      <font color=#007AA3>%value trigger/stateLocalizedString%</font>
                    %end%  
                  </td>
                  ...
                  <script>writeTDnowrap("col");</script>
                    ...
                    %case '0'%
                      %ifvar trigger/currentThreads equals('-1')%
                        ...
                        <script>
							            if(is_csrf_guard_enabled && needToInsertToken) {
							              document.write('<a href="javascript:document.htmlform_settings_soapjms_edit_state_enabled_not_connected_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
						              }else {
							              document.write('<a href="settings-jms-edit-state.dsp?triggerName=%value node_nsName encode(url)%&setState=EnabledButNotConnected&type=soap&triggerFilterValue=%value ../triggerFilterValue encode(url)%&aliasFilterValue=%value ../aliasFilterValue encode(url)%&destinationFilterValue=%value ../destinationFilterValue encode(url)%&groupHeader=%value trigger/groupHeader encode(url)%">%value trigger/stateLocalizedString%<br></a>');
							            }
					              </script>
                      ...
                      %else%
                        ...
                        <img style="width: 13px; height: 13px;" alt="active" border="0" src="images/green_check.png">
						            ...
						            <script>
							            if(is_csrf_guard_enabled && needToInsertToken) {
							              document.write('<a href="javascript:document.htmlform_settings_soapjms_edit_state_enabled_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
						              }else {
							              document.write('<a href="settings-jms-edit-state.dsp?triggerName=%value node_nsName encode(url)%&setState=Enabled&type=soap&triggerFilterValue=%value ../triggerFilterValue encode(url)%&aliasFilterValue=%value ../aliasFilterValue encode(url)%&destinationFilterValue=%value ../destinationFilterValue encode(url)%&groupHeader=%value trigger/groupHeader encode(url)%">%value trigger/stateLocalizedString%<br></a>');
						              }
					              </script>
                    ...
                    %case '1'%
                      ...
                      <script>
								        if(is_csrf_guard_enabled && needToInsertToken) {
								          document.write('<a href="javascript:document.htmlform_settings_soapjms_edit_state_disabled_%value $index%.submit();">%value trigger/stateLocalizedString%</a>');
							          }else {
								          document.write('<a href="settings-jms-edit-state.dsp?triggerName=%value node_nsName encode(url)%&setState=Disabled&type=soap&triggerFilterValue=%value ../triggerFilterValue encode(url)%&aliasFilterValue=%value ../aliasFilterValue encode(url)%&destinationFilterValue=%value ../destinationFilterValue encode(url)%&groupHeader=%value trigger/groupHeader encode(url)%">%value trigger/stateLocalizedString%<br></a>');
							          }
						          </script>
                    ...
                    %case '2'%                     
                      ...
                      <script>
							          if(is_csrf_guard_enabled && needToInsertToken) {
							            document.write('<a href="javascript:document.htmlform_settings_soapjms_edit_state_suspended_%value $index%.submit();">%value trigger/stateLocalizedString%<br></a>');
						            }else {
							            document.write('<a href="settings-jms-edit-state.dsp?triggerName=%value node_nsName encode(url)%&setState=Suspended&type=soap&triggerFilterValue=%value ../triggerFilterValue encode(url)%&aliasFilterValue=%value ../aliasFilterValue encode(url)%&destinationFilterValue=%value ../destinationFilterValue encode(url)%&groupHeader=%value trigger/groupHeader encode(url)%">%value trigger/stateLocalizedString%<br></a>');
						            }
					            </script>
