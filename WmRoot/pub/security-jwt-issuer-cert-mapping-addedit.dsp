...
<head>
  ...
  <script language="JavaScript">
    ...
    <body onLoad="loadTrustStores(); addTruststoreAliases(); addcertificateAliases(); setNavigation('security-jwt-issuer-cert-mapping-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_JWT_AddmappingScrn');">
