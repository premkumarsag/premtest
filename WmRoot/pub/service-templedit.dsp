         ...
         <TR>
          <TD colspan=2>
			...
			setFormProperty("htmlform_service_info", "service", "%value service encode(url)%");
              ...
              <li>
			  <script>getURL("service-info.dsp?service=%value service encode(url)%", "javascript:document.htmlform_service_info.submit();", "Return to %value service encode(html)%");</script>
			  </li>
            </UL>
          </TD>
        </TR>
