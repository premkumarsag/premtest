      ...
      %loop packages%
        ...
        <tr>
          ...
          %value time encode(html)%
                ...
                %ifvar ../subscribers%
				  <script>
				  createForm("htmlform_package_send_release_select_subscribers_%value $index%", "package-send-release-select-subscribers.dsp", "POST", "BODY");
				  setFormProperty("htmlform_package_send_release_select_subscribers_%value $index%", "release", "%value name encode(url)%");
				  setFormProperty("htmlform_package_send_release_select_subscribers_%value $index%", "package", "%value ../name encode(url)%");
				  </script>
				  <script>getURL("package-send-release-select-subscribers.dsp?release=%value name encode(url)%&package=%value ../name encode(url)%", "javascript:document.htmlform_package_send_release_select_subscribers_%value $index%.submit();", "<nobr>Send Release</nobr>");</script>
