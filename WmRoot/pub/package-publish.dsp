...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function releasePackage () {
        ...
        if(is_csrf_guard_enabled && needToInsertToken) {
			createForm("htmlform_package_release", "package-release.dsp", "POST", "BODY");
			setFormProperty("htmlform_package_release", "package", oldPack);
            setFormProperty("htmlform_package_release", _csrfTokenNm_, _csrfTokenVal_);
			document.htmlform_package_release.submit();
        } else {
