<html>
  ...
  <BODY onLoad="setNavigation('stats-general.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_AboutISAdmin','foo');">
                  ...
                  <td width="100%">
                    <table class="tableInline" width="100%"  cellspacing="0px" cellpadding="0px">
                      ...
                      <tr>
                        ...
                        %endinvoke%
        <br>
        Copyright &copy; 1996 - 2018 Software AG, Darmstadt, Germany and/or Software AG USA Inc., Reston, VA, USA, and/or its subsidiaries and/or its affiliates and/or their licensors.
        <br><br>
    ...
    <table class="tableView" width="100%">
                ...
                %loop -struct sysattr%
                <TR>
                  <td class="evenrow" scope="row" style="width: 10%"><nobr>%value $key encode(none)%</nobr></td>
