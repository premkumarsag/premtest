...
%ifvar type equals(complex)%<input name="type" type="hidden" value="complex">%endif%
    ...
    <td class="oddrow">Repeating</TD>
          <td class="oddrow-l" colspan=6>
            <input type="checkbox" name="doNotOverlap" id="doNotOverlap1" size=12 value="true"><label for="doNotOverlap1">Repeat after completion</label></input>
          </td>
       ...
       <tr>
        ...
        <tr>
          ...
          <td class="oddrow-l" colspan=6>
          <input name="sd2" id="sd2" size=12 > YYYY/MM/DD <i>(optional)</i></input>
          </td>
        </tr>
        <tr>
          <td class="evenrow"><label for="st2">Start Time</label></TD>
          <td class="evenrow-l" colspan=5>
          <input name="st2" id="st2" size=12 > HH:MM:SS <i>(optional)</i></input>
          </td>
        </tr>
        <tr>
          <td class="oddrow"><label for="ed2">End Date</label></TD>
          <td class="oddrow-l" colspan=6>
          <input name="ed2" id="ed2" size=12 > YYYY/MM/DD <i>(optional)</i></input>
          </td>
        </tr>
        <tr>
          <td class="evenrow"><label for="et2">End Time</label></TD>
          <td class="evenrow-l" colspan=6>
          <input name="et2" id="et2" size=12 > HH:MM:SS <i>(optional)</i></input>
          </td>
        </tr>
        <tr>
          <td class="oddrow" colspan=1>Repeating</TD>
          <td class="oddrow-l" colspan=5>
            <input type="checkbox" name="doNotOverlap" id="doNotOverlap2" size=12 value="true"><label for="doNotOverlap2">Repeat after completion</label></input>
          </td>
