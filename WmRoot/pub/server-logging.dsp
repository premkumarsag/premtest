...
function typeChange () {
  ...
  if(is_csrf_guard_enabled && needToInsertToken) {
	createForm("htmlform_server_logging", "server-logging.dsp", "POST", "BODY");
	setFormProperty("htmlform_server_logging", "component", selectedType);
    setFormProperty("htmlform_server_logging", _csrfTokenNm_, _csrfTokenVal_);
	document.htmlform_server_logging.submit();
  } else {
	  document.location = "server-logging.dsp?component="+selectedType;
  }
...
function onEdit () {
  ...
  if(is_csrf_guard_enabled && needToInsertToken) {
	  createForm("htmlform_server_logging_edit", "server-logging.dsp", "POST", "BODY");
	  setFormProperty("htmlform_server_logging_edit", "doc", "edit");
	  setFormProperty("htmlform_server_logging_edit", "component", selectedType);
		setFormProperty("htmlform_server_logging_edit", _csrfTokenNm_, _csrfTokenVal_);
		document.htmlform_server_logging_edit.submit();
  } else {
	  document.location = "server-logging.dsp?doc=edit&component="+selectedType;
  }
