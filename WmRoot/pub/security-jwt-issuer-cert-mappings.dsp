...
<head>
  ...
  <body onLoad="setNavigation('security-jwt-issuer-cert-mappings.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_JWT_IssuerCertificateMappingsScrn');">
   
    <table width="100%">
        <tr>
            <td class="breadcrumb" colspan="2"> Security &gt; JWT &gt; Issuer Certificate Mappings </td>
        </tr>
